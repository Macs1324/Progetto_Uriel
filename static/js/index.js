...
// The debounce function receives our function as a parameter
  ...
  const storeScroll = () => {
      ...
      if(window.scrollY > 1)
      {
          ...
          document.getElementsByClassName("header")[0].getElementsByClassName("logo")[0].getElementsByTagName("img")[0].style.width = "15%";
      }
      else
      {
          document.getElementsByClassName("header")[0].style.boxShadow = "none";
          document.getElementsByClassName("header")[0].getElementsByClassName("logo")[0].getElementsByTagName("img")[0].style.width = "20%";
      }
    }
